...
Connection con=DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/hospitalmanagement","root","spandana14"); 
  ...
  String name1="msd.krish@outlook.com";
  
       sql = "select pd.*,ba.* from  patientdetails pd inner join bookappointment ba using(Email) where Email= ? ";
      
       

   
       myStmt = con.prepareStatement(sql);
       myStmt.setString(1, name1);
